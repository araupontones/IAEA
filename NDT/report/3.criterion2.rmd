...
This section presents findings on the contribution of the NDT RCA programme to the increased scope and scale of NDT demand and use in the 20 countries surveyed. Particularly, the analysis aims to understand the extent to which the support of the NDT programme has contributed to the enhancement of:
...
Moreover, Figure \@ref(fig:standards-c2-sum) below shows the performance standards of the impact of NDT RCA programme on the increased scope and scale of NDT demand and use of the Government Parties.
...
Because `r text_rd_s$g_tx` have established R&D activities but have not published or organized seminars, their performance meets the defined standard for good performance in terms of R&D
