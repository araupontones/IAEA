...
```{r set_up, echo=FALSE, warning=FALSE, message=FALSE}
  ...
  #define directories
  dir_reference <- file.path(dropbox, "data/0.reference")
  dir_indicators <- file.path(dropbox, "indicators")
  
  #load tables from dropbox
  tbl_acronym <- import(file.path(dir_reference, "acronyms.xlsx")) #acronims for the report
  tbl_criterion1 <- import(file.path(dir_indicators, "indicators.xlsx"), sheet = "Criterion1") #list of indicators for criterons
