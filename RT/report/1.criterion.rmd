...
As can be seen in Figure X, that shows the distribution of specialists by method and by country, across all the GPs,in 2020 there are *X* more RT specialists in comparison with the same figure in 2000. Which represents a growth of *% growth*. In absoulte terms, the country with a higher growth of RT specialists is *count1*. However, in terms of proportional growth, *grow1* is the GP with a faster grwoth in the number of RT specialist.  
