...
As can be seen in Figure \@ref(fig:g-spec) above, that shows the distribution of RT specialists by country, **across all the GPs, there are `r txt_g$g_spec` more RT specialists in 2020 than they were in 2000. This increase represents a growth of `r txt_g$g_grow` for this period**. In absolute terms, the country with a higher growth of RT specialists since 2000 is `r txt_g$count1` (`r txt_g$count1_num` new specialists) . However, in proportional terms, `r txt_g$grow1`  is the GP with the fastest growing number of RT specialist (`r txt_g$g_perc1` more in 2020 compared to 2000). 
