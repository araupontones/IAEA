...
As can be seen in Figure \@ref(fig:survival-plot), the average survival rate increased for all GPs that reported this information during the online survey. The GPs that reported the highest 5-year survival rate are South Korea, Singapore and Philippines (80%), followed by Thailand (65%) and New Zealand (63%).
