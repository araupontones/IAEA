...
* The approximate average 5-year local control rate across all GPs in 2000 and 2020 was `r txt_control$c_0` and `r txt_control$c_20` respectively. Which implies an increase of `r txt_control$imp_c` (percentage points) in this period. 93% of the GPs that reported about the extent to which RCA contributed to the increase of the 5-year control rate between 2000 and 2020, considered that RT RCA had some positive impact to achieve this result.

* The approximate average 5-year survival rate across all types of cancer increased `r txt_control$imp_l` in 2020 with respect to 2020 across all GPs. The average survival rate was `r txt_control$l_0` in 2000 and `r txt_control$c_20` in 2020. 