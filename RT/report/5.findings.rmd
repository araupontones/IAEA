...
* There are a total of `r text_train$tot_train` educational programmes on RT available across all the GPs that are part of the RCA programme. from the 17 GPs for which an educational programme is available, 8 (47%) reported that RCA contributed to a great extent in their establishment, and 6 reported that RCA's support contributed to some extent.
